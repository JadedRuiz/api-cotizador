                            ...
                            <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                                <tr>
                                    <td width="300" class="mobile" align="center" valign="top">
                                        <img src="https://www.enriquedans.com/wp-content/uploads/2015/11/Notifications.jpg" width="100">
                                    </td>
                                    <td width="600" class="mobile" align="left" valign="middle">
                                        <font face="Arial" color="#0E888E" size="4" style="font-family: 'Raleway', sans-serif; font-weight: 400;">
                                            Hola, Tenemos un nuevo interesado
                                        </font>
                                        <br>
                                        <font face="Arial" color="#0E888E" size="2" style="font-family: 'Raleway', sans-serif; font-weight: 200;">
                                            <font style="font-weight: 400;">{{ $data_view["info_lote"]["sEtapa"]}}: Lote #{{ $data_view["info_lote"]["iLote"]}} {{$data_view["info_lote"]["sTipoLote"]}}</font>
                                        </font>
                                    </td>
                                </tr>
                            </table>
                                            ...
                                            <tr>
                                                <td class="mobile" align="center" valign="top">
                                                    <font face="Arial" color="#000000" size="3" style="font-family: 'Raleway', sans-serif; font-weight: 200;">
                                                        La Información del Interesado se muestra a continuación:
                                                    </font>
                                                </td>
                                            </tr>
                                        </table>
                                            ...
                                            <tr>
                                                ...
                                                <td bgcolor="#d3d4d4" width="200" class="mobile" align="left" valign="middle" style="padding: 10px;">
                                                    <font face="Arial" color="#000000" size="2" style="font-family: 'Raleway', sans-serif; font-weight: 200;">
                                                        {{ $data_view["info_ciudadano"]["sNombre"] }}
                                                    </font>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td bgcolor="#f2f2f2" width="200" class="mobile" align="left" valign="middle" style="padding: 10px;">
                                                    <font face="Arial" color="#000000" size="2" style="font-family: 'Raleway', sans-serif; font-weight: 200;">
                                                        {{ $data_view["info_ciudadano"]["sCorreo"] }}
                                                    </font>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td bgcolor="#d3d4d4" width="200" class="mobile" align="left" valign="middle" style="padding: 10px;">
                                                    <font face="Arial" color="#000000" size="2" style="font-family: 'Raleway', sans-serif; font-weight: 200;">
                                                        {{ $data_view["info_ciudadano"]["sTelefono"] }}
                                                    </font>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td bgcolor="#f2f2f2" width="200" class="mobile" align="left" valign="middle" style="padding: 10px;">
                                                    <font face="Arial" color="#000000" size="2" style="font-family: 'Raleway', sans-serif; font-weight: 200;">
                                                        {{ $data_view["info_ciudadano"]["sCiudad"] }}
                                                    </font>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td bgcolor="#d3d4d4" width="200" class="mobile" align="center" valign="middle" style="padding: 10px;">
                                                    <font face="Arial" color="#000000" size="2" style="font-family: 'Raleway', sans-serif; font-weight: 600;">
                                    ...
                                    <td align="center" valign="top">
                                        <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                                            <tr>
                                                <td class="mobile" align="center" valign="top">
                                                    <font face="Arial" color="#000000" size="2" style="font-family: 'Raleway', sans-serif; font-weight: 600;">
                                                        Tambien puedes ingresar al panel administrativo para ver más información del lote seleccionado
                                                    </font>
                                                </td>
                                            </tr>
                                        </table>
